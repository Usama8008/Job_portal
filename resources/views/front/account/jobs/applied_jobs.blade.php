                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{route('job.details',$jobApplication->job_id)}}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                       <form action="{{route('appliedJob.delete',$jobApplication->id )}}"  onsubmit="return confirmDelete()">
                                                            @csrf
                                                            @method('DELETE')
